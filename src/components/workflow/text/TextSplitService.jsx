...
export default function TextSplitService() {
  ...
  const [sourceTitle, setSourceTitle] = useState(
    configData[id]?.title ? configData[id]?.title : "Split"
  );
  ...
  return (
    <>
      ...
      <Divider />
      <Box>
        <Typography variant="subtitle1">Split Value</Typography>
        <TextField
          fullWidth
          value={value}
          onChange={(e) => setValue(e.target.value)}
          placeholder="Split Value Here"
        />
      </Box>
      <Box>
        <Typography variant="subtitle1">Split Position</Typography>
        <TextField
          fullWidth
          value={position}
          onChange={(e) => {
