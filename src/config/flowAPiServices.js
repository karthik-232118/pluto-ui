...
import { FLOW_BASE_URL } from "./urlConfig";
...
export const ApiServiceFlow = axios.create({
  baseURL: FLOW_BASE_URL,
  headers: HEADERS,
});
...
ApiServiceFlow.interceptors.request.use(
  (config) => {
...
ApiServiceFlow.interceptors.response.use(
  (response) => {
    return response;
  },
  (error) => {
